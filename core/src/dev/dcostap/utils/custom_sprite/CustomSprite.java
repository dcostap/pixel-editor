...
package dev.dcostap.utils.custom_sprite;
 ...
 * @author mzechner
 * @author Nathan Sweet */
public class CustomSprite extends CustomTextureRegion {
	...
	public float vertexTopLefX = 0f;
	public float vertexTopLefY = 0f;
	public float vertexTopRightX = 0f;
	public float vertexTopRightY = 0f;
	public float vertexBottomLefX = 0f;
	public float vertexBottomLefY = 0f;
	public float vertexBottomRightX = 0f;
	public float vertexBottomRightY = 0f;
	...
	public CustomSprite(CustomTextureRegion region) {
		setRegion(region);
		setColor(1, 1, 1, 1);
	 ...
	 * @param srcWidth The width of the texture region. May be negative to flip the sprite when drawn.
	 * @param srcHeight The height of the texture region. May be negative to flip the sprite when drawn. */
	public CustomSprite(CustomTextureRegion region, int srcX, int srcY, int srcWidth, int srcHeight) {
	...
	public CustomSprite(CustomSprite sprite) {
		set(sprite);
	}

	/** Make this sprite a copy in every way of the specified sprite */
	public void set (CustomSprite sprite) {
	...
	public float[] getVertices () {
		// todo re-add the dirty check (the new vertices variables would need a setter and set dirty = true)
		// but maybe it's an optimization not worth the effort
//		if (dirty) {
		if (true) {
			dirty = false;
		...
		vertices[X1] += vertexTopLefX;
		vertices[Y1] += vertexTopLefY;

		vertices[X2] += vertexTopRightX;
		vertices[Y2] += vertexTopRightY;

		vertices[X3] += vertexBottomLefX;
		vertices[Y3] += vertexBottomLefY;

		vertices[X4] += vertexBottomRightX;
		vertices[Y4] += vertexBottomRightY;
	...
	public void setRegion (float u, float v, float u2, float v2) {
		...
		float[] vertices = CustomSprite.this.vertices;
		vertices[U1] = u;
		vertices[V1] = v2;
