 ...
 * @author Nathan Sweet
 */
public class ShapeRendererFilledPolygon implements Disposable {
	/**
	...
	public ShapeRendererFilledPolygon() {
		this(5000);
	}

	public ShapeRendererFilledPolygon(int maxVertices) {
		this(maxVertices, null);
	}

	public ShapeRendererFilledPolygon(int maxVertices, ShaderProgram defaultShader) {
